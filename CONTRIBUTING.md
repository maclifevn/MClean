# Contributing to MClean

Thanks for your interest in contributing to MClean.

## Getting Started

1. Fork the repo
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/MClean.git`
3. Install prerequisites: `brew install xcodegen`
4. Generate the Xcode project: `xcodegen generate`
5. Open in Xcode: `open MClean.xcodeproj`

## Development

- MClean is built with **SwiftUI** and targets **macOS 13.0+**
